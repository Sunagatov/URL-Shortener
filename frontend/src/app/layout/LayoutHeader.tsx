...
import { FaChevronDown, FaLink, FaMoon, FaSignOutAlt, FaSun } from 'react-icons/fa';
          ...
          {isAuthenticated ? (
              ...
              >
                    ...
                    return (
                      <Link
                        ...
                        className={`relative flex items-center space-x-3 px-4 py-2.5 transition-colors duration-200 ${
                          active
                            ? 'bg-[var(--sidebar-active-bg)] text-[color:var(--text-primary)]'
                ...
                <div className="border-t border-[color:var(--border)] pt-1.5">
                  <button
                    type="button"
                    onClick={onLogout}
                    className="flex w-full items-center space-x-3 px-4 py-2.5 text-[color:var(--danger-text)] transition-colors duration-200 hover:bg-[var(--danger-hover-bg)] hover:text-[color:var(--danger-text)]"
                  >
            ...
            <div className="flex items-center space-x-3">
              ...
              {!isSignUpRoute && !isSignInRoute && (
                <Link
                  to={routes.signUp}
                  className="hidden text-sm font-medium text-[color:var(--text-secondary)] transition-colors duration-200 hover:text-[color:var(--text-primary)] md:inline"
                >
                  Sign Up
                </Link>
              )}
