          ...
          {isAuthenticated ? (
            <div className="relative">
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-2xl border border-[color:var(--border-strong)] bg-white/8 transition duration-200 hover:border-[color:var(--accent-border)] hover:bg-white/12 md:h-auto md:w-auto md:gap-2 md:px-4 md:py-2.5"
                aria-label="Open account menu"
              >
                <div className="flex h-7 w-7 items-center justify-center rounded-xl bg-white/12">
              ...
              {isUserMenuOpen && (
                <>
                  ...
                  <div className="absolute right-0 z-20 mt-2 w-60 rounded-[24px] border border-[color:var(--border)] bg-[color:var(--surface-overlay)] py-2 shadow-[0_24px_50px_rgba(4,10,24,0.42)] backdrop-blur-xl">
                    <div className="border-b border-[color:var(--border)] px-4 py-3">
                      <p className="text-sm font-semibold text-white">Account</p>
                      <p className="text-xs text-[color:var(--text-muted)]">Manage your settings</p>
                    </div>
