...
export function UrlMappingsSelectionBar({
  ...
  return (
    <div
      className="fixed bottom-6 left-1/2 z-50 flex -translate-x-1/2 items-center gap-2 rounded-2xl border border-[color:var(--border)] bg-[var(--surface-overlay)] px-4 py-3 shadow-[0_8px_40px_rgba(0,0,0,0.55)] backdrop-blur-xl"
      style={{ animation: 'modal-in 0.2s cubic-bezier(0.22,1,0.36,1) both' }}
    >
      <span className="min-w-[90px] text-sm font-medium text-[color:var(--text-secondary)]">
