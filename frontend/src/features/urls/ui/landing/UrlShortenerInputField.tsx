  ...
  return (
    <>
      <input
        ...
        className={`h-full w-full rounded-xl border border-[color:var(--border)] bg-[linear-gradient(180deg,rgba(17,24,43,0.96)_0%,rgba(11,17,32,0.98)_100%)] py-3.5 pl-11 pr-4 text-base text-[color:var(--text-primary)] shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_10px_30px_rgba(3,8,20,0.18)] placeholder-[color:var(--text-muted)] transition-all duration-200 focus:border-blue-400/35 focus:outline-none focus:ring-2 focus:ring-blue-500/35 ${error ? 'animate-error-shake border-red-500/35 focus:ring-red-500/35' : ''}`}
        spellCheck={false}
      />
      {error ? (
