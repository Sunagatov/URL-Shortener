  ...
  return (
    <div className="grid grid-cols-2 gap-3 lg:grid-cols-5">
      <SummaryCard
        ...
        icon={<FaMousePointer className="h-3.5 w-3.5 text-[color:var(--avatar-text)]" />}
      />
      <SummaryCard
        label="In Range"
        value={metrics.clicksInRange}
        icon={<FaChartLine className="h-3.5 w-3.5 text-[color:var(--accent)]" />}
      />
      <SummaryCard
        label="Unique Visitors"
        value={metrics.estimatedUniqueVisitors ?? 0}
        icon={<FaUsers className="h-3.5 w-3.5 text-violet-400" />}
        subtitle="≈ estimated"
      />
      <SummaryCard
        label="Previous Period"
        value={metrics.previousPeriodClicks}
        icon={<FaChartLine className="h-3.5 w-3.5 text-[color:var(--text-muted)]" />}
      />
