    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              I agree to the <span className="text-white/20">Terms of Service (coming soon)</span> and{' '}
                ...
                {error ? (
                    <div
                        className="flex items-center gap-2 rounded-xl border border-red-500/20 bg-red-900/20 p-4 text-sm text-red-300">
